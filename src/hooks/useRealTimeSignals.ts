...
export function useRealTimeSignals(options: UseRealTimeSignalsOptions = {}): RealTimeSignalsData {
  ...
  const loadInitialData = async () => {
    try {
      ...
      // Check for recent signals - signals are generated by external systems
      ...
      // Note: Signals are generated by external edge functions
      // If no recent signals, they will be generated automatically by the system
