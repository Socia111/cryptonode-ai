...
CREATE TABLE IF NOT EXISTS public.trading_config (
  ...
  symbol_whitelist JSONB NOT NULL DEFAULT '["BTCUSDT", "ETHUSDT", "SOLUSDT", "ADAUSDT", "DOTUSDT"]',
  created_at TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(),
  updated_at TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now()
);
...
INSERT INTO public.trading_config (
  ...
  false,
  true,
  '["BTCUSDT", "ETHUSDT", "SOLUSDT", "ADAUSDT", "DOTUSDT", "AVAXUSDT", "LINKUSDT", "MATICUSDT", "ATOMUSDT", "NEARUSDT"]'
