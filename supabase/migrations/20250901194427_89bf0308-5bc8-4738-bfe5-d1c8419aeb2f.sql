...
INSERT INTO public.signals (symbol, timeframe, direction, bar_time, price, score, atr, sl, tp, filters, indicators) VALUES
('BTCUSDT', '1h', 'LONG', NOW() - INTERVAL '1 hour', 43250.50, 89.5, 450.2, 42800.0, 44200.0, '{"volume": true, "trend": true}', '{"rsi": 65.2, "macd": 0.045, "bb_position": 0.7}'),
('ETHUSDT', '15m', 'SHORT', NOW() - INTERVAL '30 minutes', 2345.75, 82.3, 28.9, 2380.0, 2310.0, '{"volume": true, "momentum": true}', '{"rsi": 72.1, "macd": -0.012, "bb_position": 0.9}'),
('SOLUSDT', '1h', 'LONG', NOW() - INTERVAL '45 minutes', 98.45, 91.2, 3.2, 95.20, 102.50, '{"breakout": true, "volume": true}', '{"rsi": 58.9, "macd": 0.087, "bb_position": 0.6}'),
('ADAUSDT', '30m', 'LONG', NOW() - INTERVAL '20 minutes', 0.4567, 85.7, 0.012, 0.4450, 0.4720, '{"support": true, "trend": true}', '{"rsi": 48.3, "macd": 0.003, "bb_position": 0.4}'),
('DOTUSDT', '1h', 'SHORT', NOW() - INTERVAL '10 minutes', 6.789, 78.9, 0.234, 7.050, 6.450, '{"resistance": true, "volume": true}', '{"rsi": 69.8, "macd": -0.034, "bb_position": 0.8}')
ON CONFLICT DO NOTHING;

-- Create sample quantum analysis data
