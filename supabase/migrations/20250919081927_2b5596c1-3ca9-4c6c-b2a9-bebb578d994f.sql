...
BEGIN
  BEGIN
    ALTER TABLE signals DROP COLUMN created_bucket;
  EXCEPTION
...
ALTER TABLE signals
  ADD COLUMN created_bucket TIMESTAMPTZ
...
DROP INDEX IF EXISTS uq_signals_minute;
CREATE UNIQUE INDEX uq_signals_minute
