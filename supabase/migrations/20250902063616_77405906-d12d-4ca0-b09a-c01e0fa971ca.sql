...
INSERT INTO public.aira_rankings (
  rank_position, token_symbol, token_name, score, market_cap, volume_24h
) VALUES
  (1, 'FET', 'Fetch.ai', 94.5, 2500000000, 180000000),
  (2, 'OCEAN', 'Ocean Protocol', 91.2, 1800000000, 120000000),
  (3, 'AGIX', 'SingularityNET', 88.7, 1200000000, 95000000),
  (4, 'RLC', 'iExec RLC', 85.3, 850000000, 45000000),
  (5, 'TAO', 'Bittensor', 83.9, 750000000, 38000000),
  (6, 'GRT', 'The Graph', 81.4, 650000000, 55000000),
  (7, 'RENDER', 'Render Token', 79.8, 580000000, 42000000),
  (8, 'GLM', 'Golem', 77.2, 420000000, 28000000),
  (9, 'NMR', 'Numeraire', 75.6, 380000000, 15000000),
  (10, 'COTI', 'COTI', 73.1, 290000000, 22000000)
