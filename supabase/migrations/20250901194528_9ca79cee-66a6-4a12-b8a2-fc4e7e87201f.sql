...
-- Insert sample quantum analysis data (using existing table structure)
INSERT INTO public.quantum_analysis (symbol, quantum_score, probability_matrix, wave_patterns, market_sentiment, volatility_index, momentum_indicators) VALUES
('BTCUSDT', 94.2, '{"bull": 0.78, "bear": 0.22, "neutral": 0.15}', '{"elliott": "wave_3", "fibonacci": 0.618, "support": 42800}', 72.5, 1.8, '{"momentum": "strong", "divergence": false}'),
('ETHUSDT', 87.6, '{"bull": 0.65, "bear": 0.35, "neutral": 0.25}', '{"pattern": "ascending_triangle", "breakout": 0.75}', 68.3, 2.1, '{"momentum": "medium", "divergence": true}'),
('SOLUSDT', 91.8, '{"bull": 0.82, "bear": 0.18, "neutral": 0.12}', '{"trend": "uptrend", "strength": 0.89}', 78.9, 1.9, '{"momentum": "very_strong", "divergence": false}')
ON CONFLICT DO NOTHING;